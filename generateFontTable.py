...
table +=  addList(f'M.2 Drives ({mdot2DrivesFolder})', mdot2DrivesOffset, mdot2DriveSVGs)
table +=  addList(f'M.2 Small Drives ({mdot2DrivesFolder})', mdot2SmallDrivesOffset, mdot2SmallDriveSVGs)
table +=  addList(f'SATA Drives ({sataDrivesFolder})', sataDrivesOffset, sataDriveSVGs)
